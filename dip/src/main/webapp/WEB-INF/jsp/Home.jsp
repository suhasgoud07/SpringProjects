...
<head>
  ...
  <title>Explore with Destiny</title>
    ...
    <div class="container">
      ...
      <nav class="navbar">
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="/aboutMe" class="navbar-link">About Us</a>
          </li>
          ...
          <li>
            <a href="/Contacts" class="navbar-link">Contact Us</a>
          </li>
        ...
        &nbsp;&nbsp;
          <a href="/registers" class="btn btn-secondary">SIGNUP</a>
      </nav>
      ...
      <section class="section hero"
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <h2 class="hero-title">Trusted Travel Agency in India</h2>

            <p class="hero-text">
             The world is yours to explore. Go where you feel the most alive. Let the adventure begin.
            </p>
          ...
          <figure class="hero-banner">
            <img src="images/38155.png" width="686" height="812" loading="lazy" alt="hero banner"
              class="w-100">
          </figure>
      ...
      <section class="section destination">
        <div class="container">
          ...
          <ul class="destination-list">
            ...
            <li class="w-50">
              <a href="/Ladakh" class="destination-card">

                <figure class="card-banner">
                  <img src="images/Ladakh.jpg" width="1140" height="1100" loading="lazy"
                    alt="Ladakh, Jammu & Kashmir" class="img-cover">
                </figure>

                <div class="card-content">
                  <p class="card-subtitle">Ladakh</p>

                  <h3 class="h3 card-title">Jammu & Kashmir</h3>
                </div>
          ...
          <ul class="popular-list">
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-banner">
                  <a href="#">
                    <img src="images/popular-3.jpg" width="740" height="518" loading="lazy"
                      alt="Kuala Lumpur, Malaysia" class="img-cover">
                  </a>
                  ...
                  <div class="card-wrapper">
                    ...
                    <div class="author-wrapper">
                      <figure class="author-avatar">
                        <img src="images/author-avatar.png" width="30" height="30" alt="Jony bristow">
                      </figure>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="images/blog-2.jpg" width="740" height="518" loading="lazy"
                      alt="A good traveler has no fixed plans and is not intent on arriving." class="img-cover">
                  </a>
            ...
            <li>
              <div class="blog-card">
                ...
                <figure class="card-banner">
                  ...
                  <a href="#">
                    <img src="images/blog-3.jpg" width="740" height="518" loading="lazy"
                      alt="A good traveler has no fixed plans and is not intent on arriving." class="img-cover">
                  </a>
  ...
  <footer class="footer" style="background-image: url('images/footer-bg.png')">
    <div class="container">
      ...
      <div class="footer-bottom">
        ...
        <p class="copyright">
          &copy; 2023 <a href="#" class="copyright-link">www.Destiny.com</a>. All Rights Reserved
        </p>
